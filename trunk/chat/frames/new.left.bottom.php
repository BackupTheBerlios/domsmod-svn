...
?>
<table border="0" cellspacing="0" cellpadding="0" width="650" bgcolor="<?=$CS[2]?>" style="border-bottom: 1px solid <?=$CS[3]?>;">
	<tr valign="top">
		<td width="550" bgcolor="<? echo $CS['WIN_BG_1']; ?>" colspan="2" height="5"><img height="5" src="./images/spacer.gif"></td>
	</tr>
	<tr valign="top">
		<td width="650" style="<?=$borderlr?>border-top: 1px solid <?=$CS[3]?>">
		<?
			$smstart = 0;
                        $tsmilies = 0;
                        $smilies = "";
			...
			<table border=\"0\" cellspacing=\"0\" height=\"25\" cellpadding=\"0\" name=\"colortable\">
				<tr valign=\"center\">
					...
					<td width=\"160\">
                                                <font color=\"$CS[FONTLT]\">$smilies</font>
                                        </td>
			</tr>
		</table></div>");
	...
	<tr valign="top">
		...
		<?
		print("
		<div align=\"left\">&nbsp;$chatmsg: <input type=\"text\" name=\"msg\" class=\"chatbox\" size=\"57\"> <input type=\"submit\" value=\"$txt[85]\" onClick=\"javascript: setTimeout('dosndmsg()',500)\"></font></div>"
		);
		?>
		</td>
	</tr>
