...
<td width=\"250\">
<a href=\"admin.php?action=editusers&subaction=delete&id=$row[0]\">[Zmaž]</a> </a>
...
$body .= "</td>
<td width=\"150\">
<a href=\"admin.php?action=editrooms&subaction=delete&id=$row[0]\">[Zmaž]</a> ";
if($row[9] == 0){
