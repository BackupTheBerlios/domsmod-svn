...
$DATABASE['USER'] = "domsnitt_x7_1";		// Your database username
$DATABASE['PASS'] = "g0d0m$";		// Your database password
$DATABASE['DATABASE'] = "domsnitt_x7_1";		// Your database name
$DATABASE['TYPE'] = "mysql";				// Database type.  Must be mysql
$SERVER['NAME'] = "domsnittalumni.net";			// A short name for your server (less then 10 letters)
