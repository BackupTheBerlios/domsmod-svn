...
$mode_types_text = array($lang['Sort_Joined'], $lang['Sort_Userid'], $lang['Sort_Name'],$lang['Sort_Usertype'],$lang['Sort_Gradyear'],  $lang['Sort_Email']);
$mode_types = array('joined', 'username', 'name','usertype','gradyear',  'email'); 
//END-OF-FIX
...
$template->assign_vars(array(
        ...
        'L_FULLNAME' => $lang['Name'],
		'L_USERTYPE' => $lang['Usertype'],
		'L_GRADYEAR' => $lang['Gradyear'],
		'L_EMAIL' => $lang['Email'],
...
switch( $mode )
{
		...
		case 'name':
                $order_by = "name $sort_order LIMIT $start, " . $board_config['topics_per_page'];
                break;
 //FIX:DOMSNITT       
        case 'usertype':
                $order_by = "usertype $sort_order LIMIT $start, " . $board_config['topics_per_page'];
                break;
        
        case 'gradyear':
                $order_by = "gradyear $sort_order LIMIT $start, " . $board_config['topics_per_page'];
                break;
//END-OF-FIX        
		default:
                $order_by = "user_id $sort_order LIMIT $start, " . $board_config['topics_per_page'];
...
$sql = "SELECT username,name,usertype,gradyear, user_id, user_viewemail, user_posts, user_regdate, user_from, user_website, user_email, user_icq, user_aim, user_yim, user_msnm, user_avatar, user_avatar_type, user_allowavatar
        FROM " . USERS_TABLE . "
