...
define("_REGNEWUSER","New User Registration for DOMS NITT Alumni Network");
define("_LIST","List");
...
define("_YICQ","Your Skype");
define("_YAIM","Your AOL Messenger");
...
define("_YOUWILLRECEIVE","You will receive a confirmation email with a link to a page you should visit to activate your account in the next 1 Week.");
define("_BLANKFORAUTO","Leave blank for auto-generate your password");
define("_TOFINISHUSER","To finish the registration process you should visit the following link in the next 1 week to activate your user account, otherwise the information will be automaticaly deleted by the system and you should apply again:");
define("_YOUPASSMUSTBE","Your Password must be");
define("_FINISHUSERCONF","Your request for a new account has been processed. You'll receive an email in the next few seconds with a activation link that should be visited in the next 1 week to be able to activate your account.");
...
//FIX:DOMSNITT   
// START: HACK- AUM + AutoActivate
define("_AUM_DIALLOWED_EMAILDOMAIN", "The following email domain is not allowed");
define("_AUTOACTIVATE_MESSAGE","You will have a final activation message with a link to a page you should click to activate your account <b>immediately</b>.");
// END : HACK- AUM + AutoActivate
//END-OF-FIX
?>