...
<table border="0" cellpadding="0" cellspacing="0" class="tbt"><tr><td class="tbtl"><img src="themes/iCGstation/forums/images/spacer.gif" alt="" width="22" height="22" /></td><td class="tbtbot">{L_VIEWING_PROFILE}<img src="themes/iCGstation/forums/images/spacer.gif" alt="" width="8" height="22" align="absmiddle" /></td><td class="tbtr"><img src="themes/iCGstation/forums/images/spacer.gif" alt="" width="124" height="22" /></td></tr></table>
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	<td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_FULLNAME}:</span></td>
		  <td class="row1" valign="middle" width="100%"><b><span class="gen">{NAME}</span></b></td>
		</tr>
		
			<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_USERTYPE}:</span></td>
		  <td class="row1" valign="middle" width="100%"><b><span class="gen">{USERTYPE}</span></b></td>
		</tr>
		
			<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_GRADYEAR}:</span></td>
		  <td class="row1" valign="middle" width="100%"><b><span class="gen">{GRADYEAR}</span></b></td>
		</tr>
	
			<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_SPECIALIZATION}:</span></td>
		  <td class="row1" valign="middle" width="100%"><b><span class="gen">{SPECIALIZATION}</span></b></td>
		</tr>
	
				<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_COMPANY}:</span></td>
		  <td class="row1" valign="middle" width="100%"><b><span class="gen">{COMPANY}</span></b></td>
		</tr>
